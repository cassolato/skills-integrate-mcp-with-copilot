...
def verify_teacher(username: str, password: str):
    teachers = load_teachers()
    for teacher in teachers:
        matches_user = compare_digest(teacher.get("username", ""), username)
        matches_password = compare_digest(teacher.get("password", ""), password)
...
def auth_status(request: Request):
    teacher_username = request.session.get("teacher_username")
    return {
        "logged_in": bool(teacher_username),
